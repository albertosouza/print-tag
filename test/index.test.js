...
describe('makeTickets6187', function () {
  it('it should make 85 tickets', function(done) {
    var pt = new PrintTicket('pimaco_6187');

    pt.doc.pipe( fs.createWriteStream('test/results/6187.pdf') );
    pt.doc.fontSize(6);
...
describe('makeTickets6180', function () {
  it('it should make 85 tickets', function(done) {
    var pt = new PrintTicket('pimaco_6180');

    pt.doc.pipe( fs.createWriteStream('test/results/6180.pdf') );
    pt.doc.fontSize(6);
...
describe('makeTickets6081', function () {
  it('it should make 85 tickets', function(done) {
    var pt = new PrintTicket('pimaco_6081');

    pt.doc.pipe( fs.createWriteStream('test/results/6081.pdf') );
    pt.doc.fontSize(6);
